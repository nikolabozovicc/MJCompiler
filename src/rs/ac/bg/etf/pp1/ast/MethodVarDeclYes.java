...
public class MethodVarDeclYes extends MethodVarDecl {

    private MethodVarDecl MethodVarDecl;
    private VarDeclList VarDeclList;

    public MethodVarDeclYes (MethodVarDecl MethodVarDecl, VarDeclList VarDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVarDeclYes(\n");
