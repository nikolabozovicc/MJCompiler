...
public class FactorOptionsDesignFunc extends FactorOptions {

    private Designator Designator;
    private DesignStmtFuncPars DesignStmtFuncPars;

    public FactorOptionsDesignFunc (Designator Designator, DesignStmtFuncPars DesignStmtFuncPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FactorOptionsDesignFunc(\n");
